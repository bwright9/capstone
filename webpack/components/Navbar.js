...
class Navbar extends React.Component {
	...
	authLink() {
		if(this.props.auth)
			return(
				[<li key="profile"><Link className='profile-link' to="/profile">profile</Link></li>,
			...
			return( 
				...
				<li key="logout"><Link to='signup' className='login'>sign up</Link></li>]
			)
		}
	}
	...
	dropDownButton() {
		if(this.props.auth) {
			...
			return([<li key="signup"><Link to='signup' className='login'>sign up</Link></li>,
